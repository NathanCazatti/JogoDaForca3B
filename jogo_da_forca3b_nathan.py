...
# Lista de palavras separadas por temas
palavras_por_tema = {
    "programacao": [
    ...
    "jogos": [
        "minecraft", "zelda", "mario", "pokemon", "fortnite", "roblox"
    ],
    "filmes": [
        "avatar", "interestelar", "batman", "matrix", "vingadores", "titanic"
    ]
}

def escolher_palavra():
    """Escolhe uma palavra aleatória de um tema aleatório da lista."""
    tema_escolhido = random.choice(list(palavras_por_tema.keys()))
    palavra_secreta = random.choice(palavras_por_tema[tema_escolhido])
    print(f"Dica: O tema da palavra é '{tema_escolhido.capitalize()}'.")
